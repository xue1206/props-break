        ...
        if (node.kind === ts.SyntaxKind.TypeAliasDeclaration) {
            try {
                node.type.forEachChild(function(child) {
                    var ref;
                    fields.push(child === null || child === void 0 ? void 0 : (ref = child.name) === null || ref === void 0 ? void 0 : ref.escapedText);
                });
            } catch (err) {
                console.warn(err);
            }
            ...
            var ref1;
            (ref1 = node.members) === null || ref1 === void 0 ? void 0 : ref1.forEach(function(child) {
                var ref;
                fields.push(child === null || child === void 0 ? void 0 : (ref = child.name) === null || ref === void 0 ? void 0 : ref.escapedText);
            });
        }
